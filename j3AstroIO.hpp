...
/**
 * @brief Stucture to hold the lens and camera parameters that are read out from the EXIF data
 * 
 */
struct PhotoPars
{
 ...
 * @param[in] factor The image is multiplied with this number before it is written to the file
